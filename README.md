...
## Relation to direct reciprocity

This repo's game structure — two agents facing each other in a repeated dyadic game, with memory-one strategies conditioning on the last joint action — is exactly the classical **direct reciprocity** paradigm (Trivers, 1971; Axelrod & Hamilton, 1981), one of Nowak's "five rules for the evolution of cooperation" (Nowak, 2006). Tit-for-Tat, the canonical direct-reciprocity strategy, is a memory-one strategy of precisely the kind `MemoryOnePolicy` represents here, and the paper's own reliance on Press & Dyson (2012)'s zero-determinant strategies — itself a direct-reciprocity result — underlines the connection.

Where this repo (and the paper it reproduces) diverges from the classical treatment: Nowak-style direct-reciprocity results are usually **evolutionary** — many strategies compete in a population under replicator dynamics or a Moran process, and reciprocal strategies are shown to be viable against invasion by defectors. LOLA asks a **learning** question on the same substrate instead: two individual gradient-based learners, no population, no selection — does reciprocal cooperation emerge from self-interested learning alone? The answer here is conditional, not automatic: NL-vs-NL, run on the identical repeated game, collapses to permanent defection (see the reward curves discussed above), while LOLA-vs-LOLA reliably discovers TFT-like reciprocity. That contrast is the point — repeated interaction alone is not sufficient for direct reciprocity to emerge under naive gradient ascent; something functionally equivalent to LOLA's opponent-anticipation term is also required.
...
- Trivers, R. L. (1971). [The Evolution of Reciprocal Altruism](https://doi.org/10.1086/406755). The Quarterly Review of Biology, 46(1), 35-57. (Not cited by the paper; background for "Relation to direct reciprocity" above.)
- Axelrod, R., & Hamilton, W. D. (1981). [The Evolution of Cooperation](https://doi.org/10.1126/science.7466396). Science, 211(4489), 1390-1396. (Not cited by the paper; background for "Relation to direct reciprocity" above.)
- Nowak, M. A. (2006). [Five Rules for the Evolution of Cooperation](https://doi.org/10.1126/science.1133755). Science, 314(5805), 1560-1563. (Not cited by the paper; background for "Relation to direct reciprocity" above.)
